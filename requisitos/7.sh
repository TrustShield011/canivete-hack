...
echo
echo "=========================================================="
echo "[1] Veja a qual empresa de Internet o IP pertence""       |"
echo "----------------------------------------------------------"
echo "[2] Geolocalização da cidade exata do IP""                |"
echo "----------------------------------------------------------"
echo "[3] Pesquise portas abertas e seus serviços""             |"
echo "----------------------------------------------------------"
echo "[4] Verifique o status de um IP (veja se está inativo)""  |"
echo "----------------------------------------------------------"
echo "[5] Todos (Empresa, Geolocalização, Portos, Estado)""     |"
echo "----------------------------------------------------------"
...
read -p "Elige una opcion: " opc1
	case $opc1 in
			1 )	echo
				read -p "Digite o IP público do alvo: " ip
				echo
				echo "########################"
				echo "[☢] IP: $ip"
				echo "########################"
			...
			2 )	echo
				...
				echo "já que eles têm os dados mais confiáveis ​​e precisos sobre um IP público"
				;;
			3 )	echo
				read -p "Digite o IP público do alvo: " ip
				read -p "Escaneie as 1000 portas mais usadas (y)ou o 65535 (n)? (y/n): " opc2
				echo
					if [ $opc2 = y ]
						then
							echo
							...
							sudo shodan host $ip
							echo
							echo "3º Escaneamento de portas usando o ZoomEye (API): "
							...
							echo "########################"
							echo
							echo "1º Escaneo usando Nmap /65535 portas\ (No API): "
