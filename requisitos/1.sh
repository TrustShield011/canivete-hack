...
Title
echo "[1] Informações de uma página Web/Empresa"
echo
echo "============================================================"
echo "[1] Identificar a Web e reconhecer suas tecnologias""        |"
echo "------------------------------------------------------------"
echo "[2] Informações sobre o proprietário da Web/host""           |"
echo "------------------------------------------------------------"
echo "[3] Varredura do Servidor (Portas com suas Versões e SO) e ""|"
echo " (Servidores Host, DNS, MX, TXT)""                           |"
echo "------------------------------------------------------------"
echo "[4] Tente extrair IPs da Web reais protegidos pela Cloudflare"" |"
echo "------------------------------------------------------------"
echo "[5] Descubra a Criptografia SSL da Web""                     |"
echo "------------------------------------------------------------"
echo "[6] Liste todas as URLs do Domínio (Leva 2/3 minutos)""      |"
echo "------------------------------------------------------------"
echo "[7] Extrair informações sobre uma Web feita em WordPress ""  |"
echo "------------------------------------------------------------"
echo "[8] Extrair Lista de Trabalhadores""                         |"
echo "------------------------------------------------------------"
echo "[9] Extrair e-mails e números de telefone""                  |"
echo "------------------------------------------------------------"
echo "[10] Extraia todos os domínios""                             |"
echo "------------------------------------------------------------"
echo "[11] Google Dorks""                                          |"
echo "------------------------------------------------------------"
echo "[12] Verifique o status de uma Web (veja se está inativa)""  |"
echo "------------------------------------------------------------"
echo "[13] Todas as opçoes""                                       |"
echo "------------------------------------------------------------"
echo "[14] Voltar ao Menu""                                        |"
echo "============================================================"
echo
